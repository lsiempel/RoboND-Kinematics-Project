...
def handle_calculate_IK(req):
    ...
    if len(req.poses) < 1:
        ...
        # Find EE coorection rotation matrix
        ...
        for x in xrange(0, len(req.poses)):
            ...
            side_b = sqrt(pow(sqrt(WC[0]*WC[0]+WC[1]*WC[1])-a1.subs(DH_Table),2) + pow(WC[2]-d1.subs(DH_Table),2)) #WC to Joint2
            ...
            theta2 = pi/2 - angle_a - atan2(WC[2] - d1.subs(DH_Table), sqrt(WC[0]*WC[0]+WC[1]*WC[1])-a1.subs(DH_Table))
